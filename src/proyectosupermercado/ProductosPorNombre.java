...
public class ProductosPorNombre extends javax.swing.JFrame
{

    BaseDeProductos productos = new BaseDeProductos();
    BaseDeUsuarios usuarios = new BaseDeUsuarios();
    
    public ProductosPorNombre(BaseDeUsuarios u, BaseDeProductos p, String n)
    {
        initComponents();
